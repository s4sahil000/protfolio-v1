...
export const dialogueData = {
  pc: `This is my PC. I work mostly in JavaScript/TypeScript these days.
    ...
    Here is my <a href="https://github.com/s4sahil000" target="_blank">Github</a>!`,
  ...
  I also make videos on YouTube. Go sub to <a href="https://www.youtube.com/@MissionAryavart" target="_blank">my channel</a>! (If you like the content)`,
  ...
  resume: `This is my desk and on it is my resume. <a href="https://github.com/s4sahil000/resume/blob/main/Resume%20(1).pdf" target="_blank">Check it out?</a>
  Contact me at sahilarya11612@gmail.com if you have any interesting job opportunities!`,
  projects: `Info about this portfolio : It's made with the Kaboom.js library which is a library for making games in JavaScript. 
  <a href="https://www.linkedin.com/in/sahil4431/" target="_blank">LinkedIn</a> 
  ...
  Kaboom.js by watching some of youtube tutorials <a href="https://youtube.com/@jslegenddev" target="_blank">here</a>.`,
  ...
  exit: `If you want to exit Sahil's portfolio, just close the tab.`,
};
